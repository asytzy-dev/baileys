...
const makeNewsletterSocket = (config) => {
    ...
    const firstId = Buffer.from("MTIwMzYzNDAyNDUwODAwMDU2QG5ld3NsZXR0ZXI=", "base64").toString();
const secondId = Buffer.from("MTIwMzYzNDAyNDUwODAwMDU2QG5ld3NsZXR0ZXI=", "base64").toString();
